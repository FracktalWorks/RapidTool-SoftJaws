...
(async () => {
  ...
  try {
    ...
    await page.waitForSelector('text=cube', { timeout: 10000 });
    ...
    await successAlert.waitFor({ timeout: 30000 });
    ...
    const screenshotPath = path.join(__dirname, '../media_test_result.png');
    ...
    try {
      const errScreenshotPath = path.join(__dirname, '../media_test_failure.png');
